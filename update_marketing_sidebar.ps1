...
foreach ($f in $files) {
    ...
    $goalConvCls = "nav-item"
    $googleAdsCls = "nav-item"
    ...
    } elseif ($f.Name -eq "goal-conversion.html") {
        $goalConvCls = "nav-item active"
    } elseif ($f.Name -eq "google-ads.html") {
        $googleAdsCls = "nav-item active"
    }

    $newBlock = "<h3>Marketing Intelligence</h3>`n                <ul>`n                    <li><a href=`"$prefix`public/marketing/setup/setup-with-ai.html`" class=`"$setupAiCls`"><span>Setup with AI (LLM)</span><span class=`"time-badge`">2`n                                mins</span></a></li>`n                    <li><a href=`"#`" class=`"nav-item`"><span>Setup Manually</span><span class=`"time-badge`">10`n                                mins</span></a></li>`n                    <li><a href=`"$prefix`public/marketing/setup/implement-with-prompt-marketing.html`"`n                            class=`"$implPromptCls`"><span>Implement with Prompt</span></a></li>`n                    <li><a href=`"$prefix`public/marketing/setup/goal-conversion.html`" class=`"$goalConvCls`"><span>Goal Conversion</span></a></li>`n                    <li><a href=`"$prefix`public/marketing/setup/google-ads.html`" class=`"$googleAdsCls`"><span>Google Ads</span></a></li>`n                </ul>"
